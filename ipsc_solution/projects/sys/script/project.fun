...
// 项目物理通道关闭
function prj_channel_close(id, nodeid, processid, callid, ch, devno, ani, dnis, dnis2, orgcallno, dir, devtype, busitype, callstatus, endtype, ipscreason, callfailcause, callbegintime, connectbegintime, callendtime, projectid, flowid, additionalinfo1, additionalinfo2, additionalinfo3, additionalinfo4, additionalinfo5)
begin
