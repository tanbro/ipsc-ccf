# -*- coding: utf-8 -*-
#
# yunhuni-peer-comm-cti-flow documentation build configuration file, created by
...
project = u'yunhuni-peer-comm-cti-flow'
...
#
# html_title = u'yunhuni-peer-comm-cti-flow v1.0'
...
man_pages = [
    (master_doc, 'yunhuni-peer-comm-cti-flow', u'yunhuni-peer-comm-cti-flow Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yunhuni-peer-comm-cti-flow', u'yunhuni-peer-comm-cti-flow Documentation',
     author, 'yunhuni-peer-comm-cti-flow', 'One line description of project.',
     'Miscellaneous'),
]
